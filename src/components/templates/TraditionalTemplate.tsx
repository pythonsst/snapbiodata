...
export default function TraditionalTemplate({ data }: TemplateProps) {
  ...
  return (
    <div className="a4 doc relative text-ink">
      {/* Decorative double frame — repeats on every printed page */}
      ...
      {/* Content */}
      <div className="relative px-[20mm] py-[22mm] print:!px-[18mm] print:!pt-[22mm] print:!pb-[18mm]">
        {/* Header invocation */}
        {data.header && (
